...
* Automated regulation of the output gate for the targeted core saturation of 10%
  * Adjustable 
* Immediate shutdown and charge upon your field strength going below 10% or core saturation going below 5%
  * Adjustable
  * Reactor will auto activate upon a successful charge
* Immediate shutdown when your temperature goes above 8000C
  * Adjustable
  * Reactor will reactivate upon temperature cooling down to 3500C
    * Adjustable
...
* Attach an advanced computer to the back of a free stabilizer. To one of the side, either left or right, attach the 9 advanced monitor.
...
> install
```
* Modify `startup` to alter any variables at the top of the file, especially the ones holding the flow_gate_# for input and output. It is not necessary for the monitors to be directly attached to the computer. You can attach a wired modem to the monitor then connect it to the computer via network cable. If you do so, make sure to modify the variable for the monitor too.
```
> startup
```
